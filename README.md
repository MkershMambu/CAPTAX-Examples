...
* [captax01](https://github.com/MkershMambu/CAPTAX-Examples/tree/main/captax01) is represented as a hierarchical folder structure.
   * Representing capabilities is a hierarchy allows us to have discussions at different levels of abstraction
   * TBD - the README.md for each capability should define what is expected of a component that supports this capability
